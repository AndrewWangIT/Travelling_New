              ...
              <tbody>
                <tr class="odd gradeX">
                  <td>
                      ...
                      <asp:DropDownList ID="ddlStartCity" Width="110px" runat="server">
                          <asp:ListItem Text="-- 请选择出发城市 --" Selected="True" Value="0"></asp:ListItem>
                      </asp:DropDownList>
                      <asp:DropDownList ID="ddlDay" AutoPostBack="True" OnTextChanged="ddlDay_TextChanged" Width="90px" runat="server">
