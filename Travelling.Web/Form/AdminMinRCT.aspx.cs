...
{
    public partial class AdminMinRCT : System.Web.UI.Page
    {
        ...
        {
            gvAdminVisitorList.DataSource = lineService.AdminGetVisitorRecordForTomorrow();
        ...
        {
            DataTable dt = new DataTable();
            dt = lineService.AdminGetVisitorRecordForTomorrow();
            using (dt)
            {
                using (XLWorkbook wb = new XLWorkbook())
                {
                    IXLWorksheet ws = wb.Worksheets.Add(dt, "明日参团记录");
