<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Inquiry.aspx.cs" Inherits="Travelling.Web.Form.Inquiry" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

     <div class="content container_12">
        <div class="box grid_12">
        <div class="box-head"><h2>明日参团列表</h2></div>
        <div class="box-content no-pad">
            <form runat ="server">
                <asp:GridView id="gvVisitorList" Width="100%" runat="server" AutoGenerateColumns="false" BorderColor="#999999" Font-Bold="true" Font-Size="10px" BorderWidth="1px" HeaderStyle-Font-Bold="true" HeaderStyle-BackColor ="#6699ff" 
                    ...
                    DataKeyNames="id" OnRowDeleting="gvVisitorList_OnRowDeleting">
